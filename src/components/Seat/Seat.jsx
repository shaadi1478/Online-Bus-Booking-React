  ...
  const handleSeatClick = (seatNumber) => {
    if (selectedSeats.includes(seatNumber)) {
      ...
      if (selectedSeats.length < 10) {
        ...
        alert("You can only select a maxium of 10 seats at a time.");
      }
    }
  };
      ...
      <div className='space-y-5'>
          ...
          <div className="w-full md:flex justify-between">
              <div className="flex-1 w-full flex">
                  <div className="w-full flex-1 flex md:gap-x-5 gap-x-2 items-stretch">
                      ...
                      <div className="flex flex-col items-center ">
                        <div className="flex-1 space-y-4">
                          <div className="w-full grid md:grid-cols-10 grid-cols-5 gap-x-3">
              ...
              <div className="space-y-3 w-28">
                <div className="flex items-center gap-x-2">
                  <MdOutlineChair className="text-lg text-neutral-50 -rotate-90" />
                ...
                <div className="flex items-center gap-x-2">
                  <RiMoneyDollarCircleLine className="text-lg text-neutral-50" />
                  <p className="text-neutral-900 dark:text-neutral-200 text-sm font-normal ">
                    USD 9$
                  </p>
                </div>
