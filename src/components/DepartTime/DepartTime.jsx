  ...
  <div className="grid grid-cols-2 gap-10 ">
    <div className="">
      ...
      <select
        ...
        id="departbus"
        className="w-full appearance-none text-neutral-800 dark:text-neutral-100 placeholder:text-neutral-400 dark:placeholder:text-neutral-600 inline-block bg-neutral-200/60 dark:bg-neutral-900/60 px-3 h-11 border border-neutral-200 dark:border-neutral-900 rounded-md focus:outline focus:bg-neutral-100 dark:focus:bg-neutral-900"
      >
