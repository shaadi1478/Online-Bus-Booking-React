    ...
    return (
        <div className="w-full  lg:ps-28 md:ps-16 sm:px-7 px-4 mb-[8ch] ">
            ...
            <div className="grid grid-cols-3 gap-6">
                ...
                <div className="absolute top-0 left-0 bg-gradient-to-tr dark:from-neutral-950/80 dark:to-neutral-950/60 from-neutral-400/80 to-neutral-400/60 group-hover:flex hidden items-center justify-center ease-in-out duration-300 w-full h-full">
