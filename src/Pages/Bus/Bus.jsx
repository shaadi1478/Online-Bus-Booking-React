...
const Bus = () => {
    return (
        <div className="w-full  lg:ps-28 md:ps-16 sm:px-7 px-4 mt-[13ch] mb-[8ch] space-y-14">
            {/* Search and filter */}
            <div className="w-full md:grid grid-cols-6 gap-14 bg-neutral-200/60 dark:bg-neutral-900/40 rounded-md px-6 py-5 items-center justify-between">
            ...
            >
              ...
              <option value="deluxybus">Delux Bus</option>
            </select>
                </div>
            </div>
            {/* Bus cards */}
            <div className="w-full md:grid grid-cols-3 md:gap-10 gap-6">
